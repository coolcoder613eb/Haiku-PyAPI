...
void define_TranslatorRoster(py::module_& m)
{
...
.def("Translate", py::overload_cast<BPositionIO *, const translator_info *, BMessage *, BPositionIO *, unsigned int, unsigned int, const char *>(&BTranslatorRoster::Translate), "", py::arg("source"), py::arg("info"), py::arg("ioExtension"), py::arg("destination"), py::arg("wantOutType"), py::arg("hintType")=0, py::arg("hintMIME")=NULL)
.def("Translate", py::overload_cast<translator_id, BPositionIO *, BMessage *, BPositionIO *, unsigned int>(&BTranslatorRoster::Translate), "", py::arg("translatorID"), py::arg("source"), py::arg("ioExtension"), py::arg("destination"), py::arg("wantOutType"))
