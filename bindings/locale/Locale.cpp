...
.def("__copy__", &BLocale::operator=, "", py::arg("other"))
...
.def("StringCompare", py::overload_cast<const char *, const char *>(&BLocale::StringCompare, py::const_), "", py::arg("s1"), py::arg("s2"))
.def("StringCompare", py::overload_cast<const BString *, const BString *>(&BLocale::StringCompare, py::const_), "", py::arg("s1"), py::arg("s2"))
