...
void define_MailComponent(py::module_& m)
{
...
.def("SetHeaderField", py::overload_cast<const char *, const char *, unsigned int, mail_encoding, bool>(&BMailComponent::SetHeaderField), "", py::arg("key"), py::arg("value"), py::arg("charset")=B_MAIL_NULL_CONVERSION, py::arg("encoding")=null_encoding, py::arg("replace_existing")=true)
...
.def("HeaderField", py::overload_cast<const char *, int>(&BMailComponent::HeaderField), "", py::arg("key"), py::arg("index")=0)
.def("HeaderField", py::overload_cast<const char *, BMessage *, int>(&BMailComponent::HeaderField), "", py::arg("key"), py::arg("structured_header"), py::arg("index")=0)
...
.def(py::init<const char *, unsigned int>(), "", py::arg("text")=NULL, py::arg("defaultCharSet")=B_MAIL_NULL_CONVERSION)
