...
//.def("StrokeLine", py::overload_cast<BPoint, const Pattern&>(&BView::StrokeLine), "", py::arg("toPoint"), py::arg("pattern")=B_SOLID_HIGH)
.def("StrokeLine", py::overload_cast<BPoint, BPoint, ::pattern>(&BView::StrokeLine), "", py::arg("start"), py::arg("end"), py::arg("pattern"))//=pattern{{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}})//=pattern{{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}}) //B_SOLID_HIGH)
.def("StrokeLine", py::overload_cast<BPoint, ::pattern>(&BView::StrokeLine), "", py::arg("toPoint"), py::arg("pattern"))
...
.def("StringWidth", py::overload_cast<const char *, int32>(&BView::StringWidth, py::const_), "", py::arg("string"), py::arg("length"))
