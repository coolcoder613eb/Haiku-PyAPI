...
.def("GetFrameInsets", [](BControlLook& self,BControlLook::frame_type frameType,unsigned int flags) {
    float  _left;
float  _top;
float  _right;
float  _bottom;
...
.def("GetBackgroundInsets", [](BControlLook& self,BControlLook::background_type backgroundType,unsigned int flags) {
    float  _left;
float  _top;
float  _right;
float  _bottom;
...
.def("GetInsets", [](BControlLook& self,BControlLook::frame_type frameType,BControlLook::background_type backgroundType,unsigned int flags) {
    float  _left;
float  _top;
float  _right;
float  _bottom;
