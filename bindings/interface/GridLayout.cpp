...
.def("AddView", py::overload_cast<int, BView *>(&BGridLayout::AddView), "", py::arg("index"), py::arg("child"))
.def("AddView", py::overload_cast<BView *, int, int, int, int>(&BGridLayout::AddView), "", py::arg("child"), py::arg("column"), py::arg("row"), py::arg("columnCount")=1, py::arg("rowCount")=1)
.def("AddItem", py::overload_cast<BLayoutItem *>(&BGridLayout::AddItem), "", py::arg("item"))
.def("AddItem", py::overload_cast<int, BLayoutItem *>(&BGridLayout::AddItem), "", py::arg("index"), py::arg("item"))
.def("AddItem", py::overload_cast<BLayoutItem *, int, int, int, int>(&BGridLayout::AddItem), "", py::arg("item"), py::arg("column"), py::arg("row"), py::arg("columnCount")=1, py::arg("rowCount")=1)
