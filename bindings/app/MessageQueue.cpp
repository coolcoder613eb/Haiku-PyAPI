...
.def("FindMessage", py::overload_cast<int>(&BMessageQueue::FindMessage, py::const_), "", py::arg("index"))
.def("FindMessage", py::overload_cast<unsigned int, int>(&BMessageQueue::FindMessage, py::const_), "", py::arg("what"), py::arg("index")=0)
