...
.def("ReplaceInt64", py::overload_cast<const char *, int3264_t>(&BMessage::ReplaceInt64), "", py::arg("name"), py::arg("value"))
.def("ReplaceInt64", py::overload_cast<const char *, int32, int3264_t>(&BMessage::ReplaceInt64), "", py::arg("name"), py::arg("index"), py::arg("value"))
