...
.def("PostMessage", py::overload_cast<unsigned int>(&BLooper::PostMessage), "", py::arg("command"))
.def("PostMessage", py::overload_cast<BMessage *>(&BLooper::PostMessage), "", py::arg("message"))
.def("PostMessage", py::overload_cast<unsigned int, BHandler *, BHandler *>(&BLooper::PostMessage), "", py::arg("command"), py::arg("handler"), py::arg("replyTo")=NULL)
