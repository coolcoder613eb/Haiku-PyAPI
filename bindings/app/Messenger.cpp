...
.def("SendMessage", py::overload_cast<unsigned int, BHandler *>(&BMessenger::SendMessage, py::const_), "", py::arg("command"), py::arg("replyTo")=NULL)
...
.def("SendMessage", py::overload_cast<unsigned int, BMessage *>(&BMessenger::SendMessage, py::const_), "", py::arg("command"), py::arg("reply"))
