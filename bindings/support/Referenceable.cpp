...
.def("__copy__", py::overload_cast<const BReference<Type> &>(&BReference::operator=), "", py::arg("other"))
.def("__copy__", py::overload_cast<Type *>(&BReference::operator=), "", py::arg("other"))
.def("__copy__", py::overload_cast<const BReference<OtherType> &>(&BReference::operator=), "", py::arg("other"))
...
.def("__copy__", py::overload_cast<const BReference<const Type> &>(&BReference<constType>::operator=), "", py::arg("other"))
.def("__copy__", py::overload_cast<Type *>(&BReference<constType>::operator=), "", py::arg("other"))
.def("__copy__", py::overload_cast<const BReference<OtherType> &>(&BReference<constType>::operator=), "", py::arg("other"))
