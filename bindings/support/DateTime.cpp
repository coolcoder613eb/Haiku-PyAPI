...
.def(py::init<int32, int32, int32, int32>(), "", py::arg("hour"), py::arg("minute"), py::arg("second"), py::arg("microsecond")=0)
...
.def_static("IsValid", py::overload_cast<int32, int32, int32, int32>(&BTime::IsValid), "", py::arg("hour"), py::arg("minute"), py::arg("second"), py::arg("microsecond")=0)
.def_static("CurrentTime", &BTime::CurrentTime, "", py::arg("type"))
.def("Time", &BTime::Time, "")
.def("SetTime", py::overload_cast<const BTime &>(&BTime::SetTime), "", py::arg("time"))
.def("SetTime", py::overload_cast<int32, int32, int32, int32>(&BTime::SetTime), "", py::arg("hour"), py::arg("minute"), py::arg("second"), py::arg("microsecond")=0)
...
.def(py::init<int32, int32, int32>(), "", py::arg("year"), py::arg("month"), py::arg("day"))
.def(py::init<time_t, time_type>(), "", py::arg("time"), py::arg("type")=B_LOCAL_TIME)
.def(py::init<const BMessage *>(), "", py::arg("archive"))
.def("Archive", &BDate::Archive, "", py::arg("int32o"))
...
.def_static("IsValid", py::overload_cast<int32, int32, int32>(&BDate::IsValid), "", py::arg("year"), py::arg("month"), py::arg("day"))
.def_static("CurrentDate", &BDate::CurrentDate, "", py::arg("type"))
.def("Date", &BDate::Date, "")
.def("SetDate", py::overload_cast<const BDate &>(&BDate::SetDate), "", py::arg("date"))
.def("SetDate", py::overload_cast<int32, int32, int32>(&BDate::SetDate), "", py::arg("year"), py::arg("month"), py::arg("day"))
...
.def_static("IsLeapYear", py::overload_cast<int32>(&BDate::IsLeapYear), "", py::arg("year"))
...
.def_static("ShortDayName", py::overload_cast<int32>(&BDate::ShortDayName), "", py::arg("day"))
//.def("ShortMonthName", py::overload_cast<>(&BDate::ShortMonthName, py::const_), "")
.def_static("ShortMonthName", py::overload_cast<int32>(&BDate::ShortMonthName), "", py::arg("month"))
//.def("LongDayName", py::overload_cast<>(&BDate::LongDayName, py::const_), "")
.def_static("LongDayName", py::overload_cast<int32>(&BDate::LongDayName), "", py::arg("day"))
//.def("LongMonthName", py::overload_cast<>(&BDate::LongMonthName, py::const_), "")
.def_static("LongMonthName", py::overload_cast<int32>(&BDate::LongMonthName), "", py::arg("month"))
