...
void define_MediaRoster(py::module_& m)
{
...
.def("GetAudioOutput", py::overload_cast<media_node *, int, BString *>(&BMediaRoster::GetAudioOutput), "", py::arg("_node"), py::arg("_inputId"), py::arg("_inputName"))
...
.def("Connect", py::overload_cast<const media_source &, const media_destination &, media_format *, media_output *, media_input *, unsigned int, void *>(&BMediaRoster::Connect), "", py::arg("from"), py::arg("to"), py::arg("_inOutFormat"), py::arg("_output"), py::arg("_input"), py::arg("flags"), py::arg("_reserved")=NULL)
...
.def("SetProducerRunModeDelay", &BMediaRoster::SetProducerRunModeDelay, "", py::arg("node"), py::arg("delay"), py::arg("mode")=BMediaNode : : B_RECORDING)
...
.def("StartWatching", py::overload_cast<const BMessenger &, int>(&BMediaRoster::StartWatching), "", py::arg("target"), py::arg("notificationType"))
.def("StartWatching", py::overload_cast<const BMessenger &, const media_node &, int>(&BMediaRoster::StartWatching), "", py::arg("target"), py::arg("node"), py::arg("notificationType"))
.def("StopWatching", py::overload_cast<const BMessenger &>(&BMediaRoster::StopWatching), "", py::arg("target"))
.def("StopWatching", py::overload_cast<const BMessenger &, int>(&BMediaRoster::StopWatching), "", py::arg("target"), py::arg("notificationType"))
.def("StopWatching", py::overload_cast<const BMessenger &, const media_node &, int>(&BMediaRoster::StopWatching), "", py::arg("target"), py::arg("node"), py::arg("notificationType"))
...
.def("InstantiateDormantNode", py::overload_cast<const dormant_node_info &, media_node *, unsigned int>(&BMediaRoster::InstantiateDormantNode), "", py::arg("info"), py::arg("_node"), py::arg("flags"))
...
.def("GetFormatFor", py::overload_cast<const media_output &, media_format *, unsigned int>(&BMediaRoster::GetFormatFor), "", py::arg("output"), py::arg("_inOutFormat"), py::arg("flags")=0)
.def("GetFormatFor", py::overload_cast<const media_input &, media_format *, unsigned int>(&BMediaRoster::GetFormatFor), "", py::arg("input"), py::arg("_inOutFormat"), py::arg("flags")=0)
